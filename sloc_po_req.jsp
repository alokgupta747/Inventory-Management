   ...
   try
	{
		String uid = (String)session.getAttribute("uid");
		 ...
		 String q = "select a.pid,a.PDATE,B.ITEMNAME,a.QUANTITY,C.NAME from SL_PURCHASE1 a,ITEM B,SUBLOCATIONINCHARGE C WHERE A.ITEMID=B.ITEMID AND A.SLOCID=C.SUBINCHARGEID";
...
-->
	 ...
	 <th><span class="style8">Sub Location Incharge Name</span></th>
	...
	while(rs.next())
		...
		<tr>
			...
			<td><span class="style13"><a href="DeleteSlocReqOrder.jsp?id=<%=id%>">Delete</a></span></td>
		</tr>
		<%
