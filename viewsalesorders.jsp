   ...
   try
	{
		String uid = (String)session.getAttribute("uid");
	     ...
	     ResultSet rs=st.executeQuery("select a.*,b.itemname,c.name from WAREHOUSESALESORDER a,item b,sublocationincharge c where a.itemid=b.itemid and a.SUBINCHARGEID=c.SUBINCHARGEID");
	  %>
	  <html>
	  <style type="text/css">
<!--
