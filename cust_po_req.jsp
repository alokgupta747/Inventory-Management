   ...
   try
	{
		String uid = (String)session.getAttribute("uid");
		 ...
		 String q = "select a.pid,a.PDATE,B.ITEMNAME,a.QUANTITY,C.NAME from CUST_PURCHASE1 a,ITEM B,WHCUSTOMER C WHERE A.ITEMID=B.ITEMID AND A.CUSTID=C.CUSTOMERID";
...
-->
	...
	while(rs.next())
		...
		<tr>
			...
			<td><span class="style13"><a href="DeleteCustReqOrder.jsp?id=<%=id%>">Delete</a></span></td>
		</tr>
		<%
