...
-->
	  ...
	  <body >
	  <form name=f1 action="./retsalesorderprocess.jsp">
	  <table border=2>
	  <center>
...
<td><select name=s3>
		...
		<%		Statement stmt22=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);
			ResultSet rs22=stmt22.executeQuery("select * from SUBLOCATIONINCHARGE");
			 rs22.beforeFirst();
%>         <tr><td><span class="style21">Sub Location Incharge Name:</span></td>
<td><select name=s3>
              <%           
			   while(rs22.next())
			{
