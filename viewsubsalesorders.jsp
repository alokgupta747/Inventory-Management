   ...
   try
	{
		String uid = (String)session.getAttribute("uid");
	     ...
	     ResultSet rs=st.executeQuery("select a.*,b.itemname,c.name from WAREHOUSESUBSALESORDER a,item b,retailer c where a.itemid=b.itemid and a.RETAILERCHARGEID=c.RETAILERID");
	  %>
	  <html>
	  <style type="text/css">
<!--
