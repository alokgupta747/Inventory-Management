...
public class ViewRetailerStock extends HttpServlet
{
  public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
  {
     try
     {
       ...
       int retailerid=Integer.parseInt(session.getAttribute("uid").toString());
...
//         rs.absolute(rno);
       ...
       String rrr = "select b.itemname,a.qty from retstock a,item b where retailerid='"+retailerid+"' and a.itemno=b.itemid";                  
